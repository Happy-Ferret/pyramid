...
function generateMoreData() {
	...
	observations.push("Periodic Check-ins");
	observations.push("Public Repositories");
	observations.push("Good Documentation");
	observations.push("Pull Requests");
	observations.push("Co-development");
